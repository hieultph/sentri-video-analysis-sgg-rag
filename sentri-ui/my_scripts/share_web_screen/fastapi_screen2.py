...
MONITOR = {"top": 480, "left": 0, "width": 800, "height": 600}
...
if __name__ == "__main__":
    ...
    print("🖥️ Access URLs:")
    print("   - Test page: http://localhost:8082/test")
    print("   - Stream: http://localhost:8082/stream")
    print("   - API info: http://localhost:8082/")
