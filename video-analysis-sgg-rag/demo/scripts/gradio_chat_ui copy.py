...
class GradioVideoChat:
    def __init__(self, api_key: str = "hihi", base_url: str = "https://kuvncdnldlxbqd-8080.proxy.runpod.net/v1", model_name: str = "local-model"):
    ...
    def load_video_data(self, scene_data_file, index_file=None):
        ...
        try:
            ...
            # Initialize chatbot
            self.chatbot = SceneGraphChatbot(
...
def main():
    ...
    parser.add_argument("--api_key", default="hihi", help="LlamaCpp API key")
    parser.add_argument("--base_url", default="https://kuvncdnldlxbqd-8080.proxy.runpod.net/v1", help="LlamaCpp API base URL")
    parser.add_argument("--model_name", default="local-model", help="Model name to use")
